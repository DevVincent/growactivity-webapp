...
const FormLabel = styled.label`
    ...
    padding: 8px 12px;
`;
class TaskForm0 extends React.Component{
    //////////////////////////////////////////////
    ...
    renderInput = ({ input, label, meta }) => {//arrow function notation to fix unknown value of this
        ...
        return( 
            <div className={className}>
                <FormInput className="" id="taskTitle" {...input} autoComplete="off" placeholder={label}/>
    ...
    renderInputDetails = ({ input, label, meta }) => {//arrow function notation to fix unknown value of this
        ...
        return( 
            <div className={className}>
                <FormInputArea className="" id="taskDescription" {...input} autoComplete="off" placeholder={label} rows={this.state.rows}/>
                {this.renderError(meta)}
            </div>
        );
    }
...
export default reduxForm({ form: 'newGoalForm0', validate })(TaskForm0);